...
public class Main
{
    public static void main(String[] args)
    {
        ...
        nonFiksi.displayInfo(); //override method
        fiksi.displayInfo();

        Anggota anggota1 = new Anggota("Syahid Abdurrahman", "D147");
        Anggota anggota2 = new Anggota("Dimas Guntur Prasetya Sumoro", "D152");
